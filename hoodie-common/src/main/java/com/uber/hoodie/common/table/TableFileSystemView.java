...
public interface TableFileSystemView {
  ...
  interface ReadOptimizedViewWithLatestSlice {
     ...
     */
    Option<HoodieDataFile> getLatestDataFileOn(String partitionPath, String instantTime, String fileId);
  ...
  /**
   * Marker interface that implements both real-time and read-optimized latest views
   */
  interface HoodieLatestOnlyView extends RealtimeViewWithLatestSlice, ReadOptimizedViewWithLatestSlice {
  }
