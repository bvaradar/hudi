 ...
 */
public class PriorityBasedFileSystemViewDelegator implements HoodieView, Serializable {

  private static Logger log = LogManager.getLogger(PriorityBasedFileSystemViewDelegator.class);

  private final HoodieView preferredView;
  private final HoodieView secondaryView;
  private boolean errorOnPreferredView;

  public PriorityBasedFileSystemViewDelegator(HoodieView preferredView, HoodieView secondaryView) {
  ...
  @Override
  public Option<HoodieDataFile> getLatestDataFileOn(String partitionPath, String instantTime, String fileId) {
    return execute(partitionPath, instantTime, fileId, preferredView::getLatestDataFileOn,
        secondaryView::getLatestDataFileOn);
  }
  ...
  public HoodieView getPreferredView() {
    return preferredView;
  }

  public HoodieView getSecondaryView() {
