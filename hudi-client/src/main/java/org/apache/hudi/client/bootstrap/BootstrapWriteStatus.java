...
public class BootstrapWriteStatus extends WriteStatus {
  ...
  private BootstrapSourceFileInfo bootstrapSourceInfo;

  public BootstrapWriteStatus(Boolean trackSuccessRecords, Double failureFraction) {
    super(trackSuccessRecords, failureFraction);
  }

  public BootstrapSourceFileInfo getBootstrapSourceInfo() {
    return bootstrapSourceInfo;
  }

  public Pair<BootstrapSourceFileInfo, HoodieWriteStat> getBootstrapSourceAndWriteStat() {
    return Pair.of(getBootstrapSourceInfo(), getStat());
  }

  public void setBootstrapSourceInfo(BootstrapSourceFileInfo bootstrapSourceInfo) {
