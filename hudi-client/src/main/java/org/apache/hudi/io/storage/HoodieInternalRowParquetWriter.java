...
public class HoodieInternalRowParquetWriter extends ParquetWriter<InternalRow> implements HoodieInternalRowFileWriter {
    ...
    public HoodieInternalRowParquetWriter(Path file, StructType structType, Configuration configuration,
                                          HoodieWriteConfig config, HoodieParquetConfig parquetConfig)
            throws IOException {
        ...
        this.writeSupport = new HoodieRowParquetWriteSupport(configuration, structType, filter);
    }
