...
public class InternalSchemaManager implements Serializable {
  ...
  public static final InternalSchemaManager DISABLED = new InternalSchemaManager(null, InternalSchema.getEmptyInternalSchema(), null, null, new InstantFactoryV2(), new InstantFileNameParserV2());
  ...
  public static InternalSchemaManager get(Configuration conf, HoodieTableMetaClient metaClient) {
    ...
    return new InternalSchemaManager(conf, internalSchema.get(), validCommits, metaClient.getBasePath().toString(), instantFactory, parser);
  }
  ...
  InternalSchema getMergeSchema(String fileName) {
    ...
    InternalSchema fileSchema = InternalSchemaCache.getInternalSchemaByVersionId(
        ...
        validCommits, instantFactory, fileNameParser);
