...
public class HoodieDataSourceV2Writer implements DataSourceWriter {
  ...
  public HoodieDataSourceV2Writer(String instantTime, HoodieTableMetaClient metaClient,
  ...
  public DataWriterFactory<InternalRow> createWriterFactory() {
    ...
    return new HoodieDataWriterFactory(metaClient, writeConfig, instantTime, structType);
  }
