...
public class HoodieWriterCommitMessage implements WriterCommitMessage {
  ...
  private List<EncodableWriteStatus> writeStatuses = new ArrayList<>();

  public HoodieWriterCommitMessage(List<EncodableWriteStatus> writeStatuses) {
    this.writeStatuses = writeStatuses;
  }

  public List<EncodableWriteStatus> getWriteStatuses() {
